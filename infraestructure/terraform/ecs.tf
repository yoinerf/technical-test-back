...
# IAM Role para ECS Task (permisos de la aplicación)
...
# Política para acceso a DynamoDB, SES y SNS
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name  = "Jwt__SecretKeyArn"
          value = aws_secretsmanager_secret.jwt_secret.arn
        },
        {
          name  = "Jwt__Issuer"
          value = "investment-funds-api"
        },
        {
          name  = "Jwt__Audience"
          value = "investment-funds-client"
        },
        {
          name  = "AWS__SES__FromEmail"
          value = var.ses_from_email
        },
        {
          name  = "DynamoDB__CustomersTable"
          value = aws_dynamodb_table.customers.name
        },
        {
          name  = "DynamoDB__FundsTable"
          value = aws_dynamodb_table.funds.name
        },
        {
          name  = "DynamoDB__TransactionsTable"
          value = aws_dynamodb_table.transactions.name
        },
        {
          name  = "DynamoDB__SubscriptionsTable"
